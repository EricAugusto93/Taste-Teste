-- Migração para atualizar com os restaurantes reais de Porto Alegre das imagens fornecidas
-- Data: 2024-01-20

-- Primeiro, limpar dados existentes de restaurantes
DELETE FROM reviews;
DELETE FROM restaurants;

-- Inserir os 16 restaurantes reais de Porto Alegre baseados nas imagens fornecidas
