-- Inserção de dados iniciais para o Taste App
...
(
    (SELECT id FROM restaurants WHERE name = 'Pizzaria Bella Napoli' LIMIT 1),
    '00000000-0000-0000-0000-000000000001',
    5,
    'Pizza incrível! Massa fininha e ingredientes frescos. Recomendo!'
),
(
    (SELECT id FROM restaurants WHERE name = 'Burger House' LIMIT 1),
    '00000000-0000-0000-0000-000000000002',
    4,
    'Hambúrguer muito saboroso, mas o tempo de entrega foi um pouco longo.'
),
(
    (SELECT id FROM restaurants WHERE name = 'Sushi Zen' LIMIT 1),
    '00000000-0000-0000-0000-000000000003',
    5,
    'Melhor sushi da região! Peixe fresco e apresentação impecável.'
)
ON CONFLICT DO NOTHING;
