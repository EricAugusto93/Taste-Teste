-- Migração para substituir por restaurantes reais de Porto Alegre
...
-- Inserir os 16 restaurantes reais de Porto Alegre das imagens
...
(
    ...
    'Cafés especiais, design minimalista e uma experiência que vai além do copo. Na The Coffee, cada detalhe importa — do grão à sua casa. Great coffee everywhere!',
    (SELECT id FROM categories WHERE name = 'Cafeteria' LIMIT 1),
...
(
    'O Galo Cinza - Restaurante buffet',
...
(
    'Sabor de Luna - padaria uruguaya',
    ...
    -30.0346,
    -51.2177,
    'Rua Doutor Freire Alemão, 310, Bairro Mont''Serrat, Porto Alegre',
    '(51) 3333-0010',
    false
),
(
    'Peppo Cucina - Italiano',
...
-- Reviews serão adicionadas pelos usuários através do app