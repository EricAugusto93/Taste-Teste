...
void main() {
  group('RestaurantDetailsPage Tests', () {
    ...
    group('Widget Creation and Basic Display', () {
      ...
      testWidgets('should display restaurant name when provided',
          (tester) async {
        await tester.pumpWidget(createTestWidget(restaurant: mockRestaurant));
        await tester.pump();
      ...
      testWidgets(
          'should display loading widget initially when no restaurant provided',
          (tester) async {
    ...
    group('Action Buttons', () {
      ...
      testWidgets('should display phone button when phone is available',
          (tester) async {
        await tester.pumpWidget(createTestWidget(restaurant: mockRestaurant));
        await tester.pump();
      ...
      testWidgets('should display directions button when location is available',
          (tester) async {
        await tester.pumpWidget(createTestWidget(restaurant: mockRestaurant));
        await tester.pump();
    ...
    group('Reviews Section', () {
      ...
      testWidgets('should display rating dialog when rating button is tapped',
          (tester) async {
        await tester.pumpWidget(createTestWidget(restaurant: mockRestaurant));
        await tester.pump();
    ...
    group('Menu Section', () {
      testWidgets('should display menu categories when available',
          (tester) async {
        // Mock the repository calls
        when(mockReviewRepository.getReviewsByRestaurant('1'))
            .thenAnswer((_) async => []);
    ...
    group('Error Handling', () {
      testWidgets('should display error widget when restaurant loading fails',
          (tester) async {
    ...
    group('Order Flow', () {
      testWidgets('should show order options modal when order button is tapped',
          (tester) async {
        await tester.pumpWidget(createTestWidget(restaurant: mockRestaurant));
        await tester.pump();
        ...
        expect(
            find.text('Como você gostaria de fazer o pedido?'), findsOneWidget);
        expect(find.text('Delivery'), findsOneWidget);
        expect(find.text('Retirada'), findsOneWidget);
      });

      testWidgets('should display delivery information in order modal',
          (tester) async {
        await tester.pumpWidget(createTestWidget(restaurant: mockRestaurant));
        await tester.pump();
    ...
    group('Data Validation', () {
      testWidgets('should handle null restaurant data gracefully',
          (tester) async {
        ...
        await tester
            .pumpWidget(createTestWidget(restaurant: nullDataRestaurant));
        await tester.pump();
      ...
      testWidgets('should validate restaurant rating display', (tester) async {
        ...
        await tester
            .pumpWidget(createTestWidget(restaurant: highRatingRestaurant));
        await tester.pump();
      ...
      testWidgets('should validate delivery fee display', (tester) async {
        final freeDeliveryRestaurant =
            mockRestaurant.copyWith(deliveryFee: 0.0);

        await tester
            .pumpWidget(createTestWidget(restaurant: freeDeliveryRestaurant));
        await tester.pump();
