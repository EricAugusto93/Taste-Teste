...
void main() {
  group('LoadingWidget Tests', () {
    testWidgets('should render basic loading widget correctly', (tester) async {
      ...
      expect(find.text('Carregando...'),
          findsNothing); // showMessage é true mas message é null
    });
    ...
    testWidgets('should hide message when showMessage is false',
        (tester) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: Scaffold(
  ...
  group('OverlayLoadingWidget Tests', () {
    testWidgets('should render overlay loading widget correctly',
        (tester) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: Scaffold(
