...
class AccessibilityService {
  ...
  /// Executa feedback háptico médio
  void performMediumHapticFeedback() {
    if (_config.hapticFeedback) {
      HapticFeedback.mediumImpact();
    }
  }
  
  /// Executa feedback háptico forte
  void performHeavyHapticFeedback() {
    if (_config.hapticFeedback) {
