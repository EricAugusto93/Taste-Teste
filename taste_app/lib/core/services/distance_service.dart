...
class DistanceService {
  ...
  Future<double?> calculateDistanceToRestaurant(
    ...
    try {
      ...
      AnalyticsService.instance.trackEvent('distance_calculated', {
        'restaurant_id': restaurant.id,
        'distance_meters': distance,
        'method': 'haversine',
      });
      ...
      AnalyticsService.instance.trackEvent('distance_calculation_error', {
        'restaurant_id': restaurant.id,
        'error': e.toString(),
      });
  ...
  Future<Map<String, double>> calculateDistancesToRestaurants(
    ...
    try {
      ...
      AnalyticsService.instance.trackEvent('bulk_distance_calculated', {
  ...
  Future<List<RestaurantModel>> sortRestaurantsByDistance(
    ...
    try {
      ...
      AnalyticsService.instance.trackEvent('restaurants_sorted_by_distance', {
  ...
  Future<List<RestaurantModel>> filterRestaurantsWithinRadius(
    ...
    try {
      ...
      AnalyticsService.instance.trackEvent('restaurants_filtered_by_radius', {
        'original_count': restaurants.length,
        'filtered_count': filteredRestaurants.length,
        'radius_meters': radiusInMeters,
      });
